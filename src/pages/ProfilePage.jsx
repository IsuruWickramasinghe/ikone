...
function ProfilePage() {
  ...
  const { userFormData, userAddressForm, userOrderHistory } = useStateContext()
  ...
  useEffect(() => {
    ...
    if (Object.keys(userFormData).length !== 0 || Object.keys(userAddressForm).length !== 0 || userOrderHistory.length !== 0) {
